...
template <class Graph>
auto getCentroidSubgraphView(const Graph& graph, const Vertex<Graph>& centroid) {
...
template <class Graph>
std::vector<Vertex<Graph>> getAndApplyCentroids(Graph& graph, long double c = 0.33, long double delta = 0.1) {
